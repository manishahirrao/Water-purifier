...
export default function FloatingButtons() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 space-y-4">
      ...
      <motion.a
        href={callUrl}
        className="w-14 h-14 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all group relative"
      ...
      <motion.a
        ...
        className="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all group relative"
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
